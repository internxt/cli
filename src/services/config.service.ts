...
import { ExtendedLoginCredentials } from '../types/command.types';
...
export class ConfigService {
   ...
   * @async
   **/
  public saveUser = async (loginCredentials: ExtendedLoginCredentials): Promise<void> => {
   ...
   * @returns {ExtendedLoginCredentials} The authenticated user credentials
   * @async
   **/
  public readUser = async (): Promise<ExtendedLoginCredentials | undefined> => {
    try {
